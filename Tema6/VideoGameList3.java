...
class PCVideoGame extends VideoGame {
	...
	public PCVideoGame(String title, String genre, float price, Company company, int minimumRam, int minimumHD) {
	...
	public void setMinimunRam(int minimumRAM) {
		this.minimumRam = minimumRam;
	}
	...
	@Override
	public String toString() {
		return super.toString() + " {" + minimumRam + ", " + minimumHD + ("}");
	}
}
...
public class VideoGameList3
{
    ...
    public static void main(String[] args)
    {
        ...
        PCVideoGame[] games = new PCVideoGame[MAX_VIDEOGAMES];
        int chosenCompany;
        ...
        for(int i = 0; i < MAX_VIDEOGAMES; i++)
        {
            ...
            System.out.println("Enter RAM for videogame " + (i+1) + ":");
            games[i].setMinimunRam(sc.nextInt());
            
            System.out.println("Enter HD for videogame " + (i+1) + ":");
            games[i].setMinimumHD(sc.nextInt());
